...
import io.sentinelflow.geo.GeographicRateLimitService;
import io.sentinelflow.geo.GeographicAwareConfigurationResolver;
...
public class GeographicRateLimitingConfiguration {
    ...
    public GeographicRateLimitService geographicRateLimitService(
            io.sentinelflow.geo.GeoLocationService geoLocationService,
            io.sentinelflow.geo.GeographicConfigurationResolver geographicConfigResolver,
            io.sentinelflow.ratelimit.RateLimiterService rateLimiterService,
            io.sentinelflow.ratelimit.ConfigurationResolver standardConfigResolver,
    ...
    public GeographicAwareConfigurationResolver geographicAwareConfigurationResolver(
            io.sentinelflow.ratelimit.RateLimiterConfiguration configuration,
            io.sentinelflow.geo.GeographicConfigurationResolver geographicConfigResolver) {
    ...
    static class NoOpGeographicRateLimitService extends GeographicRateLimitService {
        ...
        @Override
        public io.sentinelflow.models.GeographicRateLimitResponse checkGeographicRateLimit(
            ...
            return new io.sentinelflow.models.GeographicRateLimitResponse(
                    key, tokens, true, null, "geographic-disabled", null, "GEOGRAPHIC_RATE_LIMITING_DISABLED");
        }

        @Override
        public io.sentinelflow.models.GeographicRateLimitResponse checkGeographicRateLimit(
                io.sentinelflow.models.RateLimitRequest request, String sourceIP, 
                java.util.Map<String, String> headers) {
            return checkGeographicRateLimit(request.getKey(), sourceIP, request.getTokens(), headers);
        }

        @Override
        public io.sentinelflow.models.GeoLocation detectLocation(String sourceIP, 
                java.util.Map<String, String> headers) {
            return null;
        }

        @Override
        public boolean hasGeographicRules(io.sentinelflow.models.GeoLocation geoLocation) {
            return false;
        }
