...
import io.sentinelflow.models.AdminKeyStats;
import io.sentinelflow.models.AdminKeysResponse;
import io.sentinelflow.models.AdminLimitRequest;
import io.sentinelflow.models.AdminLimitResponse;
import io.sentinelflow.ratelimit.ConfigurationResolver;
import io.sentinelflow.ratelimit.RateLimitConfig;
import io.sentinelflow.ratelimit.RateLimiterConfiguration;
...
public class AdminController {
    ...
    public ResponseEntity<AdminLimitResponse> updateKeyLimits(
        ...
        keyConfig.setAlgorithm(request.getAlgorithm() != null ? request.getAlgorithm() : io.sentinelflow.ratelimit.RateLimitAlgorithm.TOKEN_BUCKET);
