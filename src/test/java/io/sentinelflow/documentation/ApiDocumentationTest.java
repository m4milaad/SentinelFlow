package io.sentinelflow.documentation;
...
class ApiDocumentationTest {
    ...
    void testOpenApiSpecIsAvailable() {
        ...
        assertThat(response.getBody()).contains("SentinelFlow API");
    }
    ...
    void testApiInfoIsComplete() {
        ...
        assertThat(openAPI.getInfo().getTitle()).isEqualTo("SentinelFlow API");
        assertThat(openAPI.getInfo().getDescription()).contains("sentinelflow");
