...
import io.sentinelflow.models.RateLimitRequest;
import io.sentinelflow.security.ApiKeyService;
import io.sentinelflow.security.IpAddressExtractor;
import io.sentinelflow.security.IpSecurityService;
import io.sentinelflow.config.SecurityConfiguration;
...
public class RateLimitControllerTest {
    ...
    @Autowired
    private io.sentinelflow.ratelimit.CompositeRateLimiterService compositeRateLimiterService;
    ...
    static class TestConfig {
        ...
        @Bean
        public io.sentinelflow.ratelimit.CompositeRateLimiterService compositeRateLimiterService() {
            return mock(io.sentinelflow.ratelimit.CompositeRateLimiterService.class);
        }
        ...
        @Bean
        public io.sentinelflow.geo.GeographicRateLimitService geographicRateLimitService() {
            return mock(io.sentinelflow.geo.GeographicRateLimitService.class);
        }
        
        @Bean
        public io.sentinelflow.adaptive.AdaptiveRateLimitEngine adaptiveRateLimitEngine() {
            return mock(io.sentinelflow.adaptive.AdaptiveRateLimitEngine.class);
        }
    }
