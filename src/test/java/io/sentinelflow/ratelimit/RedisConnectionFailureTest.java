...
class RedisConnectionFailureTest {
    ...
    void setUp() {
        ...
        sentinelFlowService = new SentinelFlowService(resolver, redisBackend, fallbackBackend);
    }
    ...
    void testFallbackToInMemoryWhenRedisUnavailable() {
        ...
        assertTrue(sentinelFlowService.isUsingFallback());
    ...
    void testFallbackBehaviorWithMultipleKeys() {
        ...
        assertTrue(sentinelFlowService.isAllowed(key1, 10));
        assertTrue(sentinelFlowService.isAllowed(key2, 10));
    ...
    void testFallbackWhenPrimaryThrowsDuringConsume() {
        ...
        ConfigurationResolver resolver = new ConfigurationResolver(new RateLimiterConfiguration());
        SentinelFlowService service = new SentinelFlowService(
